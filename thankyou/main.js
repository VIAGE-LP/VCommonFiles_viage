...
function redirectGA() {
  ...
  if (acs_form_info == '1') {
    ...
    var acs_ga3 = $.cookie('acs_ga3');
    if (acs_ga1 && acs_ga2 && acs_ga3) {
      redirect_url += '&lp_param_ga1=' + acs_ga1;
      redirect_url += '&lp_param_ga2=' + acs_ga2;
      redirect_url += '&lp_param_ga3=' + acs_ga3;
    }
...
function redirectOrderInfo() {
  ...
  if (form_info == '1') {
    ...
    var ga3 = $.cookie('acs_ga3');
    console.log(ga1,ga2,ga3)
    ...
    // GA
     if (ga1 && ga2 && ga3) {
      redirect_url += '&lp_param_ga1=' + ga1;
      redirect_url += '&lp_param_ga2=' + ga2;
      redirect_url += '&lp_param_ga3=' + ga3;
     }
