...
var Sentry = (function (t) {
      ...
      switch (((at[t] = !0), t)) {
        case 'console':
          !(function () {
            ...
            ;['debug', 'info', 'warn', 'error', 'log', 'assert'].forEach(
              function (t) {
                t in st.console &&
                  A(st.console, t, function (n) {
                    return function () {
                      for (var r = [], e = 0; e < arguments.length; e++)
                        r[e] = arguments[e]
                      vt('console', { args: r, level: t }),
                        n && Function.prototype.apply.call(n, st.console, r)
                    }
                  })
              }
            )
        ...
        case 'dom':
          !(function () {
            ...
            st.document.addEventListener(
              'click',
              wt('click', vt.bind(null, 'dom')),
              !1
            ),
              st.document.addEventListener(
                'keypress',
              ...
              ['EventTarget', 'Node'].forEach(function (t) {
                ...
                n &&
                  ...
                  (A(n, 'addEventListener', function (t) {
                    return function (n, r, e) {
                      return (
                        r && r.handleEvent
                          ? ('click' === n &&
                              A(r, 'handleEvent', function (t) {
                                return function (n) {
                                  return (
                                    wt('click', vt.bind(null, 'dom'))(n),
                                    t.call(this, n)
                                  )
                                }
                              }),
                            'keypress' === n &&
                              A(r, 'handleEvent', function (t) {
                                return function (n) {
                                  return (
                                    gt(vt.bind(null, 'dom'))(n), t.call(this, n)
                                  )
                                }
                              }))
                          : ('click' === n &&
                              wt('click', vt.bind(null, 'dom'), !0)(this),
                            'keypress' === n && gt(vt.bind(null, 'dom'))(this)),
                        t.call(this, n, r, e)
                      )
                    }
                  }),
              ...
              return function () {
                ...
                return (
                  ...
                  'function' == typeof o.onreadystatechange
                    ? A(o, 'onreadystatechange', function (t) {
                        return function () {
          ...
          !(function () {
            ...
            A(st, 'fetch', function (t) {
              return function () {
                ...
                var e = {
                  args: n,
                  fetchData: { method: lt(n), url: dt(n) },
                  startTimestamp: Date.now()
                }
                return (
                  vt('fetch', c({}, e)),
                  t.apply(st, n).then(
                    function (t) {
                      return (
                        vt(
                          'fetch',
                          c(c({}, e), { endTimestamp: Date.now(), response: t })
                        ),
                        t
                      )
                    },
                    function (t) {
                      throw (
                        (vt(
                          'fetch',
                          c(c({}, e), { endTimestamp: Date.now(), error: t })
                        ),
                        t)
                      )
                    }
        ...
        case 'history':
          !(function () {
            ...
            ;(st.onpopstate = function () {
              for (var t = [], n = 0; n < arguments.length; n++)
                t[n] = arguments[n]
              var r = st.location.href,
                e = ut
              if (((ut = r), vt('history', { from: e, to: r }), i))
                return i.apply(this, t)
            }),
              A(st.history, 'pushState', o),
              A(st.history, 'replaceState', o)
          })()
          break
        case 'error':
          ;(Et = st.onerror),
            (st.onerror = function (t, n, r, e, i) {
              return (
                vt('error', { column: e, error: i, line: r, msg: t, url: n }),
                !!Et && Et.apply(this, arguments)
              )
            })
          break
        case 'unhandledrejection':
          ;(jt = st.onunhandledrejection),
            (st.onunhandledrejection = function (t) {
              return (
                vt('unhandledrejection', t), !jt || jt.apply(this, arguments)
              )
            })
          break
        default:
  ...
  function ht(t) {
    t &&
      ...
      ((ct[t.type] = ct[t.type] || []), ct[t.type].push(t.callback), ft(t.type))
  }
  function vt(t, n) {
    var r, e
    if (t && ct[t])
  ...
  function lt(t) {
    return (
      void 0 === t && (t = []),
      'Request' in st && E(t[0], Request) && t[0].method
  ...
  var _t = (function () {
      function t(t) {
        ...
        ;(this.l = xt.PENDING),
          ...
          (this.g = function (t, r) {
            n.l === xt.PENDING &&
              (g(r) ? r.then(n.m, n.j) : ((n.l = t), (n._ = r), n.k()))
          }),
          (this.S = function (t) {
            ...
            if (n.l !== xt.PENDING) {
              ...
              ;(n.p = []),
                t.forEach(function (t) {
                  t.done ||
                    (n.l === xt.RESOLVED && t.onfulfilled && t.onfulfilled(n._),
                    n.l === xt.REJECTED && t.onrejected && t.onrejected(n._),
                    (t.done = !0))
                })
            }
          })
  ...
  var Ot = B()
    ...
    Dt = St.nowSeconds.bind(St),
    Rt =
      (Tt.nowSeconds.bind(Tt),
      (function () {
        var t = W().performance
        if (t)
          t.timeOrigin
      ...
      (function () {
        ...
        return (
          ...
          (t.prototype.update = function (n) {
            ...
            return (
              n instanceof t
                ? ((this.A = c(c({}, this.A), n.A)),
                  (this.C = c(c({}, this.C), n.C)),
                  (this.q = c(c({}, this.q), n.q)),
                  n.M && Object.keys(n.M).length && (this.M = n.M),
                  n.L && (this.L = n.L),
                  n.F && (this.F = n.F))
                : m(n) &&
                  ((n = n),
                  (this.A = c(c({}, this.A), n.tags)),
                  (this.C = c(c({}, this.C), n.extra)),
                  (this.q = c(c({}, this.q), n.contexts)),
          ...
          (t.prototype.applyToEvent = function (t, n) {
            ...
            if (
              (this.C &&
                ...
                (t.extra = c(c({}, this.C), t.extra)),
              this.A &&
                Object.keys(this.A).length &&
                (t.tags = c(c({}, this.A), t.tags)),
              this.M &&
                Object.keys(this.M).length &&
                (t.user = c(c({}, this.M), t.user)),
              this.q &&
                Object.keys(this.q).length &&
                (t.contexts = c(c({}, this.q), t.contexts)),
            ...
            return (
              this.B(t),
              (t.breadcrumbs = h(t.breadcrumbs || [], this.N)),
              (t.breadcrumbs =
                t.breadcrumbs.length > 0 ? t.breadcrumbs : void 0),
              this.J(h(It(), this.I), t, n)
            )
          }),
      ...
      return (
        ...
        (t.prototype.startSession = function (t) {
          ...
          var n = this.getStackTop(),
            ...
            s = new Mt(
              c(
                c({ release: o, environment: u }, r && { user: r.getUser() }),
                t
              )
            )
  ...
  function Ut() {
    var t = qt()
    return (
      (Ht(t) && !Pt(t).isOlderThan(At)) || Ft(t, new Ct()),
      B()
        ? (function (t) {
            try {
              var n =
          ...
          for (var i in (e.push('dsn=' + n.toString()), t))
            if ('dsn' !== i)
              if ('user' === i) {
                if (!t.user) continue
                t.user.name &&
                  e.push('name=' + encodeURIComponent(t.user.name)),
                  t.user.email &&
  ...
  function $t(t) {
    ...
    return (
      (function (t) {
        var n = (t.defaultIntegrations && h(t.defaultIntegrations)) || [],
          r = t.integrations,
          e = []
        if (Array.isArray(r)) {
        ...
        return (
          -1 !== u.indexOf('Debug') &&
            e.push.apply(e, h(e.splice(u.indexOf('Debug'), 1))),
          e
        )
      })(t).forEach(function (t) {
        ;(n[t.name] = t),
          (function (t) {
            ;-1 === Wt.indexOf(t.name) &&
              (t.setupOnce(Nt, Ut),
              Wt.push(t.name),
              rt.log('Integration installed: ' + t.name))
          })(t)
      }),
      n
    )
  ...
  var Gt,
      ...
      return (
        ...
        (t.prototype.captureMessage = function (t, n, r, e) {
          var i = this,
            o = r && r.event_id,
            u = y(t)
              ? this.ct().eventFromMessage(String(t), n, r)
        ...
        (t.prototype.captureSession = function (t) {
          t.release
            ? this.ft(t)
            : rt.warn('Discarded session because of missing release')
        }),
        (t.prototype.getDsn = function () {
          return this.ut
        }),
        ...
        (t.prototype.lt = function (t, n) {
          ...
          t.update(
            c(c({}, u && { status: i.Crashed }), {
              user: d,
              userAgent: o,
              errors: t.errors + Number(s || u)
            })
          )
        }),
          ...
          var r = c(
            c(
              c(
                ...
                t.user && { user: P(t.user, n) }
              ),
              t.contexts && { contexts: P(t.contexts, n) }
            ),
            t.extra && { extra: P(t.extra, n) }
          )
          return (
            t.contexts &&
              t.contexts.trace &&
        ...
        (t.prototype.gt = function (t, n, r) {
          var e = this,
            ...
            u = i.sampleRate
          if (!this.vt())
            return _t.reject(new k('SDK not enabled, will not send event.'))
    ...
    Kt = (function () {
      function t(t) {
        ;(this.ot = t),
          this.ot.dsn ||
            rt.warn('No DSN provided, backend will not do anything.'),
          (this.Et = this.xt())
      }
      return (
  ...
  function Yt(t, n) {
    var r = t.tags || {},
      e = r.__sentry_samplingMethod,
      i = r.__sentry_sampleRate,
      o = (function (t, n) {
        var r = {}
        for (var e in t)
        ...
        (n = (function (t) {
          ...
          for (
            ...
            if ((r = on.exec(o[u]))) {
              ...
              r[3] && r[3].indexOf(' > eval') > -1 && (n = cn.exec(r[3]))
                ? ((r[1] = r[1] || 'eval'),
                  (r[3] = n[1]),
                  (r[4] = n[2]),
                  (r[5] = ''))
  ...
  function bn(n, r, e) {
    var i = gn(r, (e && e.syntheticException) || void 0, {
      attachStacktrace: n.attachStacktrace
    })
    return (
      Q(i, { handled: !0, type: 'generic' }),
  ...
  function wn(n, r, e, i) {
    ...
    var o = En(r, (i && i.syntheticException) || void 0, {
      attachStacktrace: n.attachStacktrace
    })
    return (
      (o.level = e), i && i.event_id && (o.event_id = i.event_id), _t.resolve(o)
    )
  }
  function gn(t, n, r) {
    var e, i
    if ((void 0 === r && (r = {}), l(t) && t.error))
      return (e = yn(hn((t = t.error))))
    if (
      d(t) ||
      ...
      return (
        K((e = En(s, n, r)), s),
        'code' in o &&
          (e.tags = c(c({}, e.tags), { 'DOMException.code': '' + o.code })),
        e
      )
    }
    return v(t)
      ...
      ? (Q(
        ...
        e)
      : (K((e = En(t, n, r)), '' + t, void 0), Q(e, { synthetic: !0 }), e)
  }
  function En(t, n, r) {
    void 0 === r && (r = {})
    var e = { message: t }
  ...
  var xn = (function () {
      ...
      return (
        ...
        (n.prototype.Mt = function (n) {
          ...
          this.At(i) &&
            rt.warn('Too many requests, backing off until: ' + this.Ct(r)),
          ...
          if (u) {
            try {
              for (
                ...
                try {
                  for (
                    var d = ((e = void 0), a(h[1].split(';'))), p = d.next();
                    !p.done;
                    p = d.next()
                  ) {
                    var y = p.value
        ...
        throw (
          ...
          Bt(function (r) {
            r.addEventProcessor(function (t) {
              var r = c({}, t)
              return (
                n.mechanism && (K(r, void 0, void 0), Q(r, n.mechanism)),
                (r.extra = c(c({}, r.extra), { arguments: e })),
                r
              )
            }),
              captureException(t)
  ...
  function In(t) {
    if ((void 0 === t && (t = {}), t.eventId))
      ...
      } else rt.error('Missing dsn option in showReportDialog call')
    else rt.error('Missing eventId option in showReportDialog call')
  }
  var Nn = (function () {
      function n(t) {
        ;(this.name = n.id),
          (this.Ut = !1),
          (this.Ht = !1),
          (this.ot = c({ onerror: !0, onunhandledrejection: !0 }, t))
      }
      return (
        (n.prototype.setupOnce = function () {
          ;(Error.stackTraceLimit = 50),
            this.ot.onerror &&
              (rt.log('Global Handler attached: onerror'), this.Pt()),
            this.ot.onunhandledrejection &&
              (rt.log('Global Handler attached: onunhandledrejection'),
              this.Ft())
        }),
    ...
    An = (function () {
      ...
      return (
        (t.prototype.setupOnce = function () {
          var t = W()
          ;(this.ot.setTimeout && A(t, 'setTimeout', this.Wt.bind(this)),
          this.ot.setInterval && A(t, 'setInterval', this.Wt.bind(this)),
          this.ot.requestAnimationFrame &&
            A(t, 'requestAnimationFrame', this.$t.bind(this)),
          this.ot.XMLHttpRequest &&
            'XMLHttpRequest' in t &&
            A(XMLHttpRequest.prototype, 'send', this.Gt.bind(this)),
          this.ot.eventTarget) &&
        ...
        (t.prototype.zt = function (t) {
          ...
          r &&
            ...
            (A(r, 'addEventListener', function (n) {
              return function (r, e, i) {
                try {
                  'function' == typeof e.handleEvent &&
                    (e.handleEvent = Rn(e.handleEvent.bind(e), {
                      mechanism: {
                        data: {
                    ...
                    A(e, t, function (n) {
                      ...
                      return (
                        n.__sentry_original__ &&
                          (r.mechanism.data.handler = R(n.__sentry_original__)),
                        Rn(n, r)
                      )
                    })
                }
      ...
      return (
        ...
        (n.prototype.Vt = function (n) {
          ...
          if ('assert' === n.level) {
            ...
            ;(r.message =
              'Assertion failed: ' +
              (N(n.args.slice(1), ' ') || 'console.assert')),
          ...
          Nt(function (n) {
            ...
            if (Ut().getIntegration(t)) {
              ...
              var o =
                  ...
                  (null === (e = Hn.location) || void 0 === e
                    ? void 0
                    : e.href),
                u = (Hn.document || {}).referrer,
                s = (Hn.navigator || {}).userAgent,
                a = c(
                  c(
                    c(
                      {},
      ...
      return (
        ...
        (n.prototype.showReportDialog = function (t) {
          void 0 === t && (t = {}),
            W().document &&
              (this.vt()
                ? In(c(c({}, t), { dsn: t.dsn || this.getDsn() }))
                : rt.error(
        ...
        (n.prototype.dt = function (n, r, e) {
          return (
            ...
            (n.sdk = c(c({}, n.sdk), {
              name: Xn,
              packages: h((n.sdk && n.sdk.packages) || [], [
    ...
    Jn = [new nn(), new Zt(), new An(), new Cn(), new Nn(), new Un(), new Pn()]
  var Wn = {},
    $n = W()
  ...
  return (
    ...
    (t.eventFromException = bn),
    (t.eventFromMessage = wn),
    (t.flush = function (t) {
      var n = Ut().getClient()
